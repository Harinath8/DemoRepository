...
export default function AddTimesheet(props) {
    ...
    // useEffect(() => {
    //     const getCostCodeDesc = async () => {
    //         const costCodeDesc = await getCostCodeDescId(addTimesheet.CostCodeDescId);
    //         setCostCodeDesc(costCodeDesc);
    //     };
    //     getCostCodeDesc();
    ...
    //     console.log(`getValue:  ${value} =event: ${event}`);
    ...
    // let projectCode = timesheetData.ProjectCode;
    // if(addTimesheet.ProjectCode) {
    //     projectCode = addTimesheet.ProjectCode;
    // }

    return (
        <div>
            <Dialog onClose={closeHandler} aria-labelledby="customized-dialog-title" open={open}>
                        ...
                        <Grid container alignItems="center" >
                            <Grid item xs={12} sm={6}>
                                <TextField
                                    ...
                                    defaultValue={moment(addTimesheet.TSDate).format('DD/MM/YYYY')}
                                    // onChange={event => { handleChange(event) }}
                                    onChange={event => { setAddTimesheet({ ...addTimesheet, TSDate: moment(event.target.value).format('DD/MM/YYYY') }) }}
                                    InputLabelProps={{
                                        shrink: true,
                                    }}
                                />
                            ...
                            <Grid item xs={12} sm={6}>
                                <TextField
                                    ...
                                    onBlur={(event) => { getProjectNameByProjectCode(event.target.value) }}
                                />
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <Autocomplete
                                    ...
                                    onChange={(event, value) => { setAddTimesheet({ ...addTimesheet, ProjectCode: value.projectCode }) }}
                                    options={options}
                                    renderInput={(params) => (
                                        <TextField
                                            {...params}
                            ...
                            <Grid item xs={12} sm={6}>
                                <FormControl style={{ width: 200 }} size="small" variant="outlined" className={classes.formControl}>
                                    <InputLabel>Cost Code Group</InputLabel>
                                    <Select
                                        native
                                        defaultValue={timesheetData.CostCodeGroupId}
                                        onChange={event => { getCostCodeGroupId(event) }}
                                    ...
                                    >
                                        ...
                                        {costCodeGroup.map((costCode) =>
                                            <option key={costCode.GH_Int} value={costCode.GH_Int}>{costCode.GHTitle_vc}
                                            </option>
                                        )}
                                    </Select>
                                </FormControl>
                            ...
                            <Grid item xs={12} sm={6}>
                                <FormControl style={{ width: 200 }} size="small" variant="outlined" className={classes.formControl}>
                                    ...
                                    <Select
                                        ...
                                        onChange={event => { setAddTimesheet({ ...addTimesheet, CostCodeGroupId: event.target.value }) }}
                                    ...
                                    >
                                        ...
                                        {costCodeDesc.map((costCode, i) =>
                                            <option key={i} value={costCode.CCode_vc}>{costCode.CCDescp_vc}
                                            </option>
                                        )}
                                    </Select>
                                </FormControl>
                            ...
                            <Grid item xs={12} sm={6}>
                                <TextField
                                    ...
                                    variant="outlined"
                                    size="small"
                                    onChange={event => { setAddTimesheet({ ...addTimesheet, RegHrs: event.target.value }) }}
                                />
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <TextField
                                    ...
                                    variant="outlined"
                                    size="small"
                                    onChange={event => { setAddTimesheet({ ...addTimesheet, OTHrs: event.target.value }) }}
                                />
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <TextField
                                    ...
                                    variant="outlined"
                                    size="small"
                                    onChange={event => { setAddTimesheet({ ...addTimesheet, JobNaration: event.target.value }) }}
                                />
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <TextField
